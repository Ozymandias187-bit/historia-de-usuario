            ...
            <ul class="nav-links">
                <li>
                    <a href="dashboard_resumen.html" class="${marcarActivo('dashboard')}">
                        <span class="nav-icon" aria-hidden="true">📊</span><span class="nav-text">Panel Control</span>
                    </a>
                </li>
                <li>
                    <a href="historial_movimientos.html" class="${marcarActivo('historial')}">
                        <span class="nav-icon" aria-hidden="true">📋</span><span class="nav-text">Inventario</span>
                    </a>
                </li>
                <li>
                    <a href="registro_concesionario.html" class="${marcarActivo('concesionario')}">
                        <span class="nav-icon" aria-hidden="true">➕</span><span class="nav-text">Nuevo Ingreso</span>
                    </a>
                </li>
                <li>
                    <a href="catalogo.html" class="${marcarActivo('catalogo')}">
                        <span class="nav-icon" aria-hidden="true">🚘</span><span class="nav-text">Catálogo</span>
                    </a>
                </li>
                <li>
                    <a href="perfil_configuracion.html" class="${marcarActivo('perfil')}">
                        <span class="nav-icon" aria-hidden="true">⚙️</span><span class="nav-text">Configuración</span>
                    </a>
                </li>
            </ul>
        </nav>
